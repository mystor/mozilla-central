...
class Transaction {
 public:
  ...
  // Apply the changes from this transaction to the specified SyncedContext in
  // all processes. This method will call the correct `MaySet` and `DidSet`
  // methods, as well as move the value.
  //
 ...
 private:
  ...
  // Helper for invoking `std::get` or `mozilla::Tuple` using a
